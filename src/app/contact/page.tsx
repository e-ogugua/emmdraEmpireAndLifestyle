              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4 p-4 bg-white/95 backdrop-blur-sm rounded-xl border-2 border-gray-300/70 shadow-lg">
                  <a href="https://facebook.com/emmdraempire" target="_blank" rel="noopener noreferrer"
                     className="w-12 h-12 sm:w-12 sm:h-12 bg-blue-600 hover:bg-blue-700 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 shadow-lg hover:shadow-xl group border-2 border-blue-700/50 transform hover:-translate-y-1">
                  ...
                  <a href="https://instagram.com/emmdraempire" target="_blank" rel="noopener noreferrer"
                     className="w-12 h-12 sm:w-12 sm:h-12 bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 hover:from-purple-600 hover:via-pink-600 hover:to-red-600 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 shadow-lg hover:shadow-xl group border-2 border-purple-600/50 transform hover:-translate-y-1">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://twitter.com/emmdraempire" target="_blank" rel="noopener noreferrer"
                     className="w-12 h-12 sm:w-12 sm:h-12 bg-sky-600 hover:bg-sky-700 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 shadow-lg hover:shadow-xl group border-2 border-sky-700/50 transform hover:-translate-y-1">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://wa.me/2348122394397" target="_blank" rel="noopener noreferrer"
                     className="w-12 h-12 sm:w-12 sm:h-12 bg-green-600 hover:bg-green-700 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 shadow-lg hover:shadow-xl group border-2 border-green-700/50 transform hover:-translate-y-1">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://pinterest.com/emmdraempire" target="_blank" rel="noopener noreferrer"
                     className="w-12 h-12 sm:w-12 sm:h-12 bg-red-600 hover:bg-red-700 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 shadow-lg hover:shadow-xl group border-2 border-red-700/50 transform hover:-translate-y-1">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://tiktok.com/@emmdraempire" target="_blank" rel="noopener noreferrer"
                     className="w-12 h-12 sm:w-12 sm:h-12 bg-black hover:bg-gray-900 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 shadow-lg hover:shadow-xl group border-2 border-gray-800/50 transform hover:-translate-y-1">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-600 mb-3">Join 200+ creative minds learning together</p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full py-4 px-6 rounded-lg font-bold text-lg transition-all duration-300 shadow-lg border-2 min-h-[56px] flex items-center justify-center gap-2 transform hover:scale-105 active:scale-95 ${
                    isSubmitting
                      ? 'bg-gray-400 text-white border-gray-300 cursor-not-allowed opacity-75'
                      : 'bg-brand-burnt-orange text-white hover:bg-red-600 border-brand-burnt-orange hover:border-red-600 hover:shadow-xl hover:-translate-y-1 active:translate-y-0'
                  }`}
                >
                  {isSubmitting ? (
                    <>

          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 p-8">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4 p-3 bg-gray-50/50 rounded-lg border border-gray-200/50">
                  <a href="https://facebook.com/emmdraempire" target="_blank" rel="noopener noreferrer"
                     className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group border-2 border-blue-600/30 hover:border-blue-700/50">
                    <svg className="w-4 h-4 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform drop-shadow-sm" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://twitter.com/emmdraempire" target="_blank" rel="noopener noreferrer"
                     className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-sky-500 to-blue-500 rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group border-2 border-sky-500/30 hover:border-blue-600/50">
                    <svg className="w-4 h-4 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform drop-shadow-sm" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://instagram.com/emmdraempire" target="_blank" rel="noopener noreferrer"
                     className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-pink-500 to-rose-500 rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group border-2 border-pink-500/30 hover:border-rose-600/50">
                    <svg className="w-4 h-4 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform drop-shadow-sm" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://wa.me/2348122394397" target="_blank" rel="noopener noreferrer"
                     className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl group border-2 border-green-500/30 hover:border-green-700/50">
                    <svg className="w-4 h-4 sm:w-6 sm:h-6 text-white group-hover:scale-110 transition-transform drop-shadow-sm" fill="currentColor" viewBox="0 0 24 24">

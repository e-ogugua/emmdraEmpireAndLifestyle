      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Emmdra Empire Admin Dashboard</h1>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200 hover:shadow-md transition-shadow">
                ...
                <Link href="/admin/products" className="mt-4 inline-block text-emerald-600 hover:text-emerald-800 text-sm font-semibold transition-colors">
                  Manage Products →
                </Link>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200 hover:shadow-md transition-shadow">
                ...
                <Link href="/admin/blog" className="mt-4 inline-block text-blue-600 hover:text-blue-800 text-sm font-semibold transition-colors">
                  Manage Blogs →
                </Link>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200 hover:shadow-md transition-shadow">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-semibold text-gray-700">DIY Tutorials</p>
                    <p className="text-2xl font-bold text-gray-900">{stats.diyTutorials}</p>
                  </div>
                </div>
                <Link href="/admin/diy" className="mt-4 inline-block text-yellow-600 hover:text-yellow-800 text-sm font-semibold transition-colors">
                  Manage DIY →
                </Link>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200 hover:shadow-md transition-shadow">
                ...
                <Link href="/admin/workshops" className="mt-4 inline-block text-purple-600 hover:text-purple-800 text-sm font-semibold transition-colors">
                  Manage Workshops →
                </Link>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200 hover:shadow-md transition-shadow">
                ...
                <Link href="/admin/bookings" className="mt-4 inline-block text-red-600 hover:text-red-800 text-sm font-semibold transition-colors">
                  Manage Bookings →
                </Link>
              </div>
            </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                ...
                <div className="space-y-4">
                  {stats.recentActivity.length > 0 ? (
                      ...
                      <div key={`${activity.type}-${activity.id}`} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-b-0">
                        <div className="flex items-center">
                          <div className={`w-2 h-2 rounded-full mr-3 ${
                            activity.type === 'Product' ? 'bg-emerald-500' :
                    ...
                    <p className="text-gray-600 text-center py-8 font-medium">No recent activity</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Link href="/admin/products/new" className="bg-emerald-50 hover:bg-emerald-100 p-4 rounded-lg border border-emerald-200 transition-colors group">
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-emerald-600 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                    </svg>
                    <span className="text-emerald-800 font-semibold">Add Product</span>
                  </div>
                </Link>

                <Link href="/admin/blog/new" className="bg-blue-50 hover:bg-blue-100 p-4 rounded-lg border border-blue-200 transition-colors group">
                  <div className="flex items-center">
                    ...
                    <span className="text-blue-800 font-semibold">Add Blog Post</span>
                  </div>
                </Link>

                <Link href="/admin/diy/new" className="bg-yellow-50 hover:bg-yellow-100 p-4 rounded-lg border border-yellow-200 transition-colors group">
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-yellow-600 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 8a9 9 0 110-18 9 9 0 010 18z" />
                    </svg>
                    <span className="text-yellow-800 font-semibold">Add DIY Tutorial</span>
                  </div>
                </Link>

                <Link href="/admin/workshops/new" className="bg-purple-50 hover:bg-purple-100 p-4 rounded-lg border border-purple-200 transition-colors group">
                  <div className="flex items-center">
                    ...
                    <span className="text-purple-800 font-semibold">Add Workshop</span>
                  </div>
                </Link>
              </div>
            </div>

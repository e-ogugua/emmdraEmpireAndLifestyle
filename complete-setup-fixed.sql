-- =============================================
-- EMMDRA EMPIRE COMPLETE DATABASE SETUP
-- =============================================
-- Fixed version -- Run this ENTIRE script in Supabase SQL Editor
-- https://supabase.com/dashboard/project/kjfqspuygiatifebgpkd/sql

-- =============================================
-- 1️⃣ DROP EXISTING TABLES (Clean Start)
-- =============================================
...
-- =============================================
-- 2️⃣ CREATE TABLES WITH CORRECT STRUCTURE
-- =============================================
...
-- Blogs Table (Fixed - no slug column)
CREATE TABLE blogs (
  id SERIAL PRIMARY KEY,
  title TEXT NOT NULL,
  category TEXT NOT NULL,
...
-- Admin write access (for development)
...
('DIY Natural Beauty Remedies at Home', 'Beauty',
...
('Building a Capsule Wardrobe for Busy Professionals', 'Lifestyle',
...
('The Art of Accessorizing: Less is More', 'Fashion',
'Master the subtle art of choosing the right accessories to elevate any outfit.',
'Accessories can make or break an outfit. Learn when to go bold and when to keep it minimal, how to mix metals, and how to choose pieces that reflect your personality.',
'{"fashion", "accessories", "style tips", "minimalism"}',
'/images/Accessories.png', true),

('Skincare Routine for Different Skin Types', 'Beauty',
'Find the perfect skincare routine tailored to your specific skin type and concerns.',
'Whether you have oily, dry, combination, or sensitive skin, we break down the essential steps and products you need.',
...
('Natural Hair Treatment Mask', 'Beauty', 'Beginner',
...
('DIY Ankara Throw Pillow', 'Home Decor', 'Intermediate',
...
CREATE INDEX idx_diy_tutorials_category ON diy_tutorials(category);
CREATE INDEX idx_diy_tutorials_difficulty ON diy_tutorials(difficulty);
